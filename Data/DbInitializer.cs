...
namespace CEPiK.Data
{
    public static class DbInitializer
    {
        public static void Initialize(CepikContext context)
        {
            ...
            {
                new Diagnostician { Name="Ryszard", Surname="Zieliński", NumberOfPremissions=0321, VehicleControlStationID=1 },
                new Diagnostician { Name="Robert", Surname="Głębocki", NumberOfPremissions=1324, VehicleControlStationID=2 },
                new Diagnostician { Name="Damian", Surname="Furtak", NumberOfPremissions=3531, VehicleControlStationID=3 },
                new Diagnostician { Name="Zenon", Surname="Moszczyński", NumberOfPremissions=5325, VehicleControlStationID=4 },
                new Diagnostician { Name="Zbigniew", Surname="Karwacki", NumberOfPremissions=6342, VehicleControlStationID=5 },
                 new Diagnostician { Name="Harry", Surname="Matejko", NumberOfPremissions=3551, VehicleControlStationID=2 },
                new Diagnostician { Name="Henryk", Surname="Antonio", NumberOfPremissions=5312, VehicleControlStationID=2 },
                new Diagnostician { Name="Janusz", Surname="Kacpszyk", NumberOfPremissions=6532, VehicleControlStationID=2 },
            };
            ...
            {
                new VehicleControlStation {VehicleControlStationID=1, Name="U Romana" , Address = addresses[0], Diagnosticians = {diagnosticians[0]}, Entrepreneur =entrepreneurs[1] , NIP =5423642344, Services = {services[0], services[2]}},
                new VehicleControlStation {VehicleControlStationID=2, Name="Stacja" , Address = addresses[1], Diagnosticians = {diagnosticians[5],diagnosticians[6],diagnosticians[7]}, Entrepreneur =entrepreneurs[1] , NIP =5423642000, Services = {services[1], services[3]}},
                new VehicleControlStation {VehicleControlStationID=3, Name="Kontroli" , Address = addresses[2], Diagnosticians = {diagnosticians[1] }, Entrepreneur =entrepreneurs[1] , NIP =5423642001, Services = {services[0], services[4]}},
                new VehicleControlStation {VehicleControlStationID=4, Name="Pojazdów" , Address = addresses[3], Diagnosticians = {diagnosticians[2] }, Entrepreneur =entrepreneurs[1] , NIP =5423642002, Services = {services[2], services[3]}},
                new VehicleControlStation {VehicleControlStationID=5, Name="Zapraszamy" , Address = addresses[4], Diagnosticians = {diagnosticians[4] }, Entrepreneur =entrepreneurs[1] , NIP =5423642003, Services = {services[0], services[3]}},
            };
